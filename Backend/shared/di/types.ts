...
export const TYPES = {
  ...
  GetCompanyLogoViewUrlUseCasePort: Symbol('GetCompanyLogoViewUrlUseCasePort'),
  ...
  GetInterviewerAssignmentResumeViewUrlUseCasePort: Symbol(
    'GetInterviewerAssignmentResumeViewUrlUseCasePort'
  ),
  ...
  GetInterviewerProfilePicViewUrlUseCasePort: Symbol('GetInterviewerProfilePicViewUrlUseCasePort'),
  ...
  GetHrProfilePicViewUrlUseCasePort: Symbol('GetHrProfilePicViewUrlUseCasePort'),
