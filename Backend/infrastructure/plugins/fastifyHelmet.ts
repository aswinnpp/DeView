    ...
    await fastify.register(helmet, {
        contentSecurityPolicy: {
            ...
            directives: {
                ...
                scriptSrc: ["'self'", ...stripeScriptHosts],
                scriptSrcElem: ["'self'", ...stripeScriptHosts],
                imgSrc: allowedImageHosts,
                fontSrc: ["'self'", 'data:', 'https:'],
                connectSrc: ["'self'", ...stripeConnectHosts],
                frameSrc: [...frameParticipants, ...stripeScriptHosts, 'https://hooks.stripe.com'],
