...
const LandingPage = () => {
    return (
        <div className="min-h-screen relative font-[Inter,-apple-system,BlinkMacSystemFont,'Segoe_UI',Roboto,sans-serif] text-white overflow-x-hidden">
            ...
            {/* Header */}
            <header className="fixed top-0 left-0 right-0 z-[100] flex justify-between items-center py-5 px-15 bg-[rgba(15,15,25,0.9)] backdrop-blur-[10px] border-b border-[rgba(255,255,255,0.1)] max-md:px-6 max-md:py-4">
                <div className="flex items-center gap-3">
                    <div className="w-10 h-10 bg-linear-to-br from-brand-primary to-brand-secondary rounded-[10px] flex items-center justify-center text-xl font-bold">D</div>
                    <h1 className="text-[22px] font-bold tracking-[2px] m-0">DEVIEW</h1>
                </div>
                <nav className="flex items-center gap-6">
                    <Link to="/login" className="text-[rgba(255,255,255,0.8)] no-underline text-[15px] font-medium">Login</Link>
                    <Link to="/register" className="bg-linear-to-br from-brand-primary to-brand-secondary text-white py-2.5 px-6 rounded-lg no-underline font-semibold text-sm">Get Started</Link>
                </nav>
            </header>

            {/* Hero Section */}
            <section className="min-h-screen flex items-center justify-center pt-[120px] pb-20 px-15 text-center max-md:pt-[100px] max-md:pb-15 max-md:px-6">
                <div className="max-w-[800px]">
                    <span className="inline-block bg-[rgba(102,126,234,0.15)] border border-[rgba(102,126,234,0.3)] text-[#a5b4fc] py-2 px-5 rounded-[20px] text-sm font-medium mb-6">Developer Interview Platform</span>
                    <h1 className="text-[56px] font-extrabold leading-[1.2] mb-6 max-md:text-4xl">
                    ...
                    <p className="text-xl text-[rgba(255,255,255,0.7)] leading-relaxed mb-10 max-w-[600px] mx-auto max-md:text-base">
                    ...
                    <div className="flex gap-4 justify-center max-md:flex-col">
                        <Link to="/register" className="bg-linear-to-br from-brand-primary to-brand-secondary text-white py-4 px-8 rounded-[10px] no-underline font-semibold text-base">Start Free Trial</Link>
                        <Link to="/login" className="bg-[rgba(255,255,255,0.1)] text-white py-4 px-8 rounded-[10px] no-underline font-semibold text-base border border-[rgba(255,255,255,0.2)]">Sign In</Link>
                    </div>
                </div>
            </section>

            {/* Features Section */}
            <section className="py-25 px-15 bg-[rgba(15,15,25,0.5)] max-md:py-15 max-md:px-6">
                <h2 className="text-center text-4xl font-bold mb-4 max-md:text-[28px]">Why Choose DEVIEW?</h2>
                <p className="text-center text-lg text-[rgba(255,255,255,0.6)] max-w-[600px] mx-auto mb-[50px] leading-relaxed">
                ...
                <div className="grid grid-cols-4 gap-6 max-w-[1200px] mx-auto max-lg:grid-cols-2 max-md:grid-cols-1">
                    {[
                        ...
                        <div key={i} className="bg-[rgba(255,255,255,0.03)] border border-[rgba(255,255,255,0.08)] rounded-2xl py-8 px-6 text-center">
                            ...
                            <p className="text-sm text-[rgba(255,255,255,0.6)] leading-relaxed">{feature.desc}</p>
                        </div>
                    ))}
                </div>
            </section>
            ...
            <section className="py-25 px-15 max-md:py-15 max-md:px-6">
                <h2 className="text-center text-4xl font-bold mb-4 max-md:text-[28px]">What Makes DEVIEW Unique</h2>
                <p className="text-center text-lg text-[rgba(255,255,255,0.6)] max-w-[600px] mx-auto mb-[50px] leading-relaxed">
                ...
                <div className="grid grid-cols-3 gap-6 max-w-[1100px] mx-auto max-lg:grid-cols-2 max-md:grid-cols-1">
                    ...
                    {[
                        ...
                        <div key={i} className="flex gap-4 p-6 bg-[rgba(255,255,255,0.03)] border border-[rgba(255,255,255,0.08)] rounded-xl transition-all duration-300 hover:-translate-y-0.5 hover:border-[rgba(255,255,255,0.15)]">
            ...
            {/* How It Works */}
            <section className="py-25 px-15 bg-[rgba(15,15,25,0.5)] max-md:py-15 max-md:px-6">
                <h2 className="text-center text-4xl font-bold mb-4 max-md:text-[28px]">How It Works</h2>
                <p className="text-center text-lg text-[rgba(255,255,255,0.6)] max-w-[600px] mx-auto mb-[50px] leading-relaxed">
                    Get started in minutes with our simple onboarding process.
                </p>
                <div className="flex items-center justify-center gap-5 max-w-[900px] mx-auto max-md:flex-col">
                    {[
                        ...
                        <React.Fragment key={i}>
                            ...
                            <div className="text-center flex-1">
                                <div className="w-[50px] h-[50px] bg-linear-to-br from-brand-primary to-brand-secondary rounded-full flex items-center justify-center text-xl font-bold mx-auto mb-4">{step.num}</div>
                                <h3 className="text-lg font-semibold mb-2">{step.title}</h3>
                                <p className="text-sm text-[rgba(255,255,255,0.6)] leading-normal">{step.desc}</p>
                            </div>
                        </React.Fragment>
                    ))}
                </div>
            ...
            {/* Stats Section */}
            <section className="py-20 px-15 bg-linear-to-br from-[rgba(102,126,234,0.08)] to-[rgba(118,75,162,0.08)] flex justify-center gap-20 max-lg:gap-10 max-md:flex-wrap max-md:gap-[30px] max-md:py-10 max-md:px-6">
                {[
                    ...
                    <div key={i} className="text-center max-md:flex-[1_1_40%]">
                        <span className="block text-[42px] font-extrabold bg-linear-to-br from-brand-primary to-brand-pink bg-clip-text text-transparent">{stat.number}</span>
                        <span className="text-sm text-[rgba(255,255,255,0.6)] mt-1 block">{stat.label}</span>
                    </div>
                ))}
            </section>
            ...
            {/* Use Cases */}
            <section className="py-25 px-15 max-md:py-15 max-md:px-6">
                <h2 className="text-center text-4xl font-bold mb-4 max-md:text-[28px]">Built for Technical Hiring</h2>
                <p className="text-center text-lg text-[rgba(255,255,255,0.6)] max-w-[600px] mx-auto mb-[50px] leading-relaxed">
                ...
                <div className="grid grid-cols-3 gap-6 max-w-[1000px] mx-auto max-md:grid-cols-1">
                    {[
                        ...
                        <div key={i} className="bg-[rgba(255,255,255,0.03)] border border-[rgba(255,255,255,0.08)] rounded-2xl p-8 text-center">
                            <h4 className="text-xl font-semibold mb-3 text-[#a5b4fc]">{uc.title}</h4>
                            <p className="text-[15px] text-[rgba(255,255,255,0.6)] leading-relaxed">{uc.desc}</p>
                        </div>
                    ))}
                </div>
            </section>
            ...
            {/* CTA Section */}
            <section className="py-25 px-15 bg-[rgba(15,15,25,0.5)] text-center max-md:py-15 max-md:px-6">
                <div>
                    <h2 className="text-[40px] font-bold mb-4 max-md:text-[28px]">Ready to Transform Your Technical Hiring?</h2>
            ...
            {/* Footer */}
            <footer className="py-10 px-15 border-t border-[rgba(255,255,255,0.1)] bg-[rgba(15,15,25,0.9)] max-md:px-6">
