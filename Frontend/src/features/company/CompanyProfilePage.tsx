...
const CompanyPaymentCheckout: React.FC<{
    ...
    const handleConfirm = async () => {
        ...
        setErrorMessage(
            `Payment not completed${status ? ` (status: ${status})` : ""
            }`,
        );
        setIsConfirming(false);
    };
                            ...
                            {subscription
                                ...
                                .map((plan, index) => {
                                    ...
                                    return (
                                        <div
                                            key={plan.id || index}
                                            className={`relative rounded-2xl border p-7 max-md:p-6 min-h-[260px] ${isCurrentPlan
                                        ...
                                        >
                                            ...
                                            <ul className="space-y-2.5 mb-7 text-sm text-slate-200">
                                                ...
                                                <li className="flex items-center">
                                                    <span
                                                        className={`w-1.5 h-1.5 rounded-full mr-3 ${plan.hasAI ? "bg-violet-400" : "bg-slate-600"
                                                            }`}
                                                    ></span>
                                            ...
                                            <Button
                                                ...
                                                className={`w-full py-2.5 rounded-lg text-sm font-semibold transition border ${isCurrentPlan
                ...
                <div className="fixed inset-0 z-[1200] flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
                    <div className="dv-pop bg-gradient-to-b from-slate-800 to-slate-900 rounded-2xl max-w-md w-full shadow-2xl shadow-black/50 border border-slate-600/80 overflow-hidden">
                        <div className="px-6 pt-7 pb-6 text-center">
                            <div
                                className={`mx-auto mb-4 w-16 h-16 rounded-2xl flex items-center justify-center ${paymentResult.status === "success"
